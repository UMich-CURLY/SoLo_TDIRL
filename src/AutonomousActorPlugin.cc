...
#include "autonomous_actor/ActorPlugin.hh"
...
void ActorPlugin::Reset()
{
  ...
  if (this->sdf && this->sdf->HasElement("target"))
    ...
    this->target = ignition::math::Vector3d(0, -5, 0);
...
void ActorPlugin::ChooseNewTarget()
{
  ...
  while ((newTarget - this->target).Length() < 2.0)
  {
    ...
    newTarget.X(ignition::math::Rand::DblUniform(1, 6));
    newTarget.Y(ignition::math::Rand::DblUniform(-1, -6));
